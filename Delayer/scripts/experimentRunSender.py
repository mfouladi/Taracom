...
args = ["./unitExperimentSender",num_of_packets,probe_packet_length, compression_node_addr, "L"]
...
#arguments to be given to subprocess
args = ["./unitExperimentSender",num_of_packets,probe_packet_length, compression_node_addr, "H"]
str_args = [ str(x) for x in args ] #convert args to string
