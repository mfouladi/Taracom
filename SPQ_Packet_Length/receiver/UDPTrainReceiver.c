...
error_t UDPTrainReceiver (char* buffer, int probe_packet_length, int high_priority_additional_payload_length, unsigned long initial_experiment_run_time, unsigned long later_experiment_run_time)
{
	...
	probe_packet_length += high_priority_additional_payload_length;
...
int main(int argc, char *argv[])
{
  ...
  if(argc != 4){
    ...
    fprintf(stderr, "Usage: ./receiver experiment_run_time probe_packet_length high_priority_additional_payload_length\n"); 
  ...
  if(UDPTrainReceiver(send_buffer, probe_packet_length, high_priority_additional_payload_length, initial_experiment_run_time,  later_experiment_run_time)!= 0)
  {
